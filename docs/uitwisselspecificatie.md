...
De uitwisselspecificatie bevat mogelijkheden om voor één gemeente aan te leveren, maar ook in één keer voor meerdere gemeenten. Bijvoorbeeld door een softwareleverancier die meerdere gemeenten op het Cloud-platform heeft, of voor samenwerkingsorganisaties die uitvoering geven aan schuldhulpverlening voor meerdere gemeenten. Hieronder wordt toegelicht hoe de uitwisselspecificatie hiervoor op de juiste manier wordt gevuld.

Om voorgaande varianten vanuit de uitwisselspecificatie te ondersteunen kent deze het concept `leveringen`. Hiermee kan in één aanlevering (= 1 JSON-bestand) voor meerdere organisaties de schuldhulpverleningstrajecten worden aangeleverd.

[![Leveringen in het uitwisselschema](images/Leveringen.jpg)](images/Leveringen.jpg)
